 ...
 */
public class vinContactFragment extends Fragment {

    public static vinContactFragment newInstance() {

        vinContactFragment f = new vinContactFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        */
        ...
        View v = inflater.inflate(R.layout.contact_fragment, parent, false);
